...
v1 complete through phases 0–5 (see [`SPEC.md` §9](SPEC.md#9-phases)). v2 is planned and its intent approved: per-device strips, protocol v4, an iPad layout and a per-app volume spike, in [`SPEC.md` Part II](SPEC.md#part-ii--v2) (§13–§22, spec 2.1; Phase 6 is next) and the v2 section of [`INTENT.md`](INTENT.md#v2--approved). Control Center widgets stay for later (§10).
